...
const crypto = require('node:crypto') // bu TARZ (node:) ifade grüyorsak, node modules klasörü içinde hazır olarak gelen modül demektir, tekrar npm i demeye gerek yoktur
